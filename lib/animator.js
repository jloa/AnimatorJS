...
(function(window){
	...
	var animator = {
		 ...
		 */
		animate:function(element, delay, duration, iterations, direction, timingFunc, frames, stopOnLastFrame)
		{
			// correct
			...
			element.bind('webkitAnimationEnd animationend', function() { $(this).attr('style', $(this).data('end-props')); });
